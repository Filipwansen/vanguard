...
<?php $__env->startSection('page-title', __('How to API')); ?>
<?php $__env->startSection('page-heading', __('API')); ?>

<?php $__env->startSection('breadcrumbs'); ?>
    <li class="breadcrumb-item active">
        <?php echo app('translator')->get('API how to use'); ?>
    </li>
...
<div class="card">
   <div class="card-body">
    ...
    border-radius: 3px;"><?php echo e(url('api')); ?>/ocr</span>
                </div>
            </div>
        </div>
        <div class="row">
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\nvanguard\resources\views/ocr/api-index.blade.php ENDPATH**/ ?>